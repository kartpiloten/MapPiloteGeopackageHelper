...
/// <summary>
/// Tests for WAL (Write-Ahead Logging) functionality.
...
public class TestWalFunctionality
{
    ...
    {
        string walGpkg = TestOutputHelper.GetTestOutputPath("wal");
        string normalGpkg = TestOutputHelper.GetTestOutputPath("normal");
        ...
        TestOutputHelper.LogOutputLocation(walGpkg);
        TestOutputHelper.LogOutputLocation(normalGpkg);
    }
